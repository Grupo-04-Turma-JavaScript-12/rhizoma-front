export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#2C6575] text-white py-14 px-6">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="w-24 h-1 bg-[#2F7A3E] mx-auto rounded-full mb-10"></div>
        ...
        <div className="grid md:grid-cols-[1.3fr_1fr_1.3fr] gap-12 items-start">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              />
              <button className="bg-[#2F7A3E] hover:bg-[#256530] transition px-5 py-2 rounded-full font-medium text-sm shadow-md hover:shadow-lg">
                Inscrever
              </button>
            </div>
          </div>
